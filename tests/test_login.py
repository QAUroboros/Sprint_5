...
def test_enter_in_account_from_button_main_page(open_browser):
    driver = open_browser
...
def test_enter_from_button_personal_account(open_browser):
    driver = open_browser
...
def test_enter_in_account_from_registration_form(open_browser):
    driver = open_browser
    login_button_main = driver.find_element(*LOGIN_BUTTON_MAIN)
    login_button_main.click()
    time.sleep(3)
...
def test_enter_in_account_from_forgot_password(open_browser):
    driver = open_browser
